...
//m.def("multiply", py::overload_cast<double, FunctionTree<D> &, PyFunctionTreeVector<D> &, int >(&multiply<D>));
...
//
//
//py::class_<ConvolutionOperator<1>> convop(m, "ConvolutionOperator");
//convop
//.def(py::init<MultiResolutionAnalysis<1> &, double>());
